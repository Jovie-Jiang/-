<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="vmTypeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="货道行" align="center" width="100" prop="vmRow" />
      <el-table-column label="货道列" align="center" width="100" prop="vmCol" />
      <el-table-column label="设备容量" align="center" width="100" prop="channelMaxCapacity" />
      <!-- 创建日期 -->
      <el-table-column label="创建日期" align="center" prop="createTime" width="180">
      </el-table-column>
      <el-table-column label="操作" align="center" width="200" lass-name="small-padding fixed-width">
        <template #default="scope">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="货道数" prop="vmRow">
          <el-input-number :min="1" :max="100" v-model="form.vmRow" placeholder="请输入货道行" />行 &nbsp;&nbsp;
          <el-input-number :min="1" :max="100" v-model="form.vmCol" placeholder="请输入货道列" />列
        </el-form-item>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除设备类型类型编号为"' + _ids + '"的数据项？').then(function() {
